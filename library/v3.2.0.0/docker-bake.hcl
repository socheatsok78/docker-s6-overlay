...
target "s6-overlay" {
  ...
  tags = [
    ...
    "ghcr.io/${replace(GITHUB_REPOSITORY, "docker-", "")}:v3.2.0.0",
  ]
}
...
target "s6-overlay-symlinks" {
  ...
  tags = [
    ...
    "ghcr.io/${replace(GITHUB_REPOSITORY, "docker-", "")}:v3.2.0.0-symlinks",
  ]
}
...
target "s6-overlay-syslogd" {
  ...
  tags = [
    ...
    "ghcr.io/${replace(GITHUB_REPOSITORY, "docker-", "")}:v3.2.0.0-syslogd",
  ]
}
